...
{
    public class EventoPatrocinadorManagement : BaseManagement
    {
        ...
        public List<T> RetrieveAlls<T>()
        {
            ...
            try
            {
                var lista = _factory.RetrieveAll<EventoPatrocinador>();
        ...
        public List<T> RetrieveAllByIdRol<T>(EventoPatrocinador eventoPatrocinador)
        {
            var lst = new List<T>();
            try
            {
                var list = _factory.RetrieveAllById<RolPermiso>(eventoPatrocinador);
                if (list.Count > 0)
                {
                    foreach (var obj in list)
                    {
        ...
        public void Delete(EventoPatrocinador eventoPatrocinador)
        {
            try
            {
                _factory.Delete(eventoPatrocinador);
            }
            catch (Exception ex)
            {
