...
namespace Challengeme.DataAccess.Crud
{
    public class CrudRol : CrudFactory
    {
        ...
        private readonly RolMapper _mapper;
        ...
        public override bool Create(BaseEntity entity)
        {
            try
            {
                ...
                operation = _mapper.GetCreateStatement(entity);
        ...
        public override T Retrieve<T>(BaseEntity entity)
        {
            ...
            //en la BD
            var rolEncontrado = _mapper.BuildObject(list);//contruye el objeto pasandole los datos
                                                           //a cada atributo
            try
            {
                if (lstResult.Count <= 0) return default(T);
                list = lstResult[0];
                rolEncontrado = _mapper.BuildObject(list);
            ...
            return (T)Convert.ChangeType(rolEncontrado, typeof(T));
