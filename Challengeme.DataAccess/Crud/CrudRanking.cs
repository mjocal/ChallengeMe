...
{
    public class CrudRanking : CrudFactory
    {
        public CrudRanking()
        {
            _mapper = new RankingMapper();

        }
        private readonly RankingMapper _mapper;
        ...
        public override List<T> RetrieveAllById<T>(BaseEntity entity)
        {
            ...
            {
                var instance = SqlDao.GetInstance();
                var lstResult = instance.ExecuteQueryProcedure(_mapper.GetRetriveAllByIdRanking(entity));
