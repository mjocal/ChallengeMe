...
{
    public class CrudPuntoRuta : CrudFactory
    {
       
            public CrudPuntoRuta()
            {
                _mapper = new PuntoRutaMapper();
            }
            private readonly PuntoRutaMapper _mapper;
            ...
            public override T Retrieve<T>(BaseEntity entity)
            {
                ...
                var producto = _mapper.BuildObject(lista);

                return (T)Convert.ChangeType(producto, typeof(T));
            ...
            public override List<T> RetrieveAllById<T>(BaseEntity entity)
            {
                ...
                {
                    var instance = SqlDao.GetInstance();
                    var lstResult = instance.ExecuteQueryProcedure(_mapper.GetRetrieveAllByIdRuta(entity));
