...
{
    public class CrudPremio : CrudFactory
    {
        public CrudPremio()
        {
            _mapper = new PremioMapper();
        }

        private readonly PremioMapper _mapper;
        ...
        public override T Retrieve<T>(BaseEntity entity)
        {
            ...
            var premio = _mapper.BuildObject(lista);

            return (T)Convert.ChangeType(premio, typeof(T));
        }
